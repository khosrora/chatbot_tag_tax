(function () {
  window.ChatbotWidget = {
    init: function (config) {
      ...
      let sessionId = localStorage.getItem("chatbot-sessionId");
      if (!sessionId) {
        sessionId = crypto.randomUUID();
        localStorage.setItem("chatbot-sessionId", sessionId);
      }
  ...
  <button id="chatbot-close">&times;</button>
          ...
          <div class="chat-input">
            ...
            <button id="chatbot-send">
                 <svg  xmlns="http://www.w3.org/2000/svg" color="black"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-down-dashed"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5v.5m0 3v1.5m0 3v6" /><path d="M18 13l-6 6" /><path d="M6 13l6 6" /></svg>
            </button>
          </div>
          <div class="chat-footer">Powered by <strong>AvidFlow</strong></div>
        </div>
        <button class="chat-toggle-btn" id="chatbot-toggle">
      ...
      function typeMessage(container, text, className = "bot", includeLogo = false) {
  ...
  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-message"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 9h8" /><path d="M8 13h6" /><path d="M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12z" /></svg>
      ...
      async function sendMessage() {
        ...
        try {
          ...
          const botReply = data?.text || data?.output || " لطفاً دوباره تلاش کنید. ❗";
